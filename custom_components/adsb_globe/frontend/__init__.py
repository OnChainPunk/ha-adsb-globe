...
Copied from the Flightradar24 integration pattern: static path +
auto-add a Lovelace resource so the card appears in Add card with
no YAML and no manual resource step.
"""
